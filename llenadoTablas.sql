...
VALUES
  (1, 'venta', 1, '111', 'CAT001', 'MAT001', 'FOL001', 'muros de piedra ', 'dueño directo'),
  (2, 'anticretico', 1, '122', 'CAT002', 'MAT002', 'FOL002', 'muros de ladrillo', 'dueño directo'),
  (3, 'alquiler', 1, 's/n', 'CAT003', 'MAT003', 'FOL003', 'rejas metalicas ', 'dueño directo'),
  ...
  (8, 'alquiler', 1, 's/n', 'CAT008', 'MAT008', 'FOL008', 'puerta con sensores de movimiento', 'dueño directo'),
  (9, 'venta', 1, '109', 'CAT009', 'MAT009', 'FOL009', 'camaras de seguridad', 'dueño directo'),
...
(2, 1, '98765432', 'Teléfono principal'),
(2, 2, '23456789', 'Teléfono secundario'),

(3, 1, '34567890', 'Teléfono principal'),
(3, 2, '09876543', 'Teléfono secundario'),

(4, 1, '56789012', 'Teléfono principal'),
(4, 2, '34567890', 'Teléfono secundario'),

(5, 1, '78901234', 'Teléfono principal'),
(5, 2, '45678901', 'Teléfono secundario'),

(6, 1, '90123456', 'Teléfono principal'),
(6, 2, '56789012', 'Teléfono secundario'),

(7, 1, '12345678', 'Teléfono principal'),
(7, 2, '23456789', 'Teléfono secundario'),

(8, 1, '34567890', 'Teléfono principal'),
(8, 2, '45678901', 'Teléfono secundario'),

(9, 1, '56789012', 'Teléfono principal'),
(9, 2, '67890123', 'Teléfono secundario'),

(10, 1, '78901234', 'Teléfono principal'),
(10, 2, '89012345', 'Teléfono secundario'),

(11, 1, '12345678', 'Teléfono principal'),
(11, 2, '87654321', 'Teléfono secundario'),

(12, 1, '98765432', 'Teléfono principal'),
(12, 2, '23456789', 'Teléfono secundario'),

(13, 1, '34567890', 'Teléfono principal'),
(13, 2, '09876543', 'Teléfono secundario'),

(14, 1, '56789012', 'Teléfono principal'),
(14, 2, '34567890', 'Teléfono secundario'),

(15, 1, '78901234', 'Teléfono principal'),
(15, 2, '45678901', 'Teléfono secundario'),

(16, 1, '90123456', 'Teléfono principal'),
(16, 2, '56789012', 'Teléfono secundario'),

(17, 1, '12345678', 'Teléfono principal'),
(17, 2, '23456789', 'Teléfono secundario'),

(18, 1, '34567890', 'Teléfono principal'),
(18, 2, '45678901', 'Teléfono secundario'),

(19, 1, '56789012', 'Teléfono principal'),
(19, 2, '67890123', 'Teléfono secundario'),

(20, 1, '78901234', 'Teléfono principal'),
(20, 2, '89012345', 'Teléfono secundario');
...
VALUES
(1, 1, 'Juan Pérez', 'Calle Principal, Ciudad'),
(2, 1, 'María López', 'Avenida Central, Ciudad'),
(3, 2, 'Carlos García', 'Calle Secundaria, Ciudad'),
(4, 2, 'Ana Rodríguez', 'Avenida Norte, Ciudad'),
(5, 1, 'Pedro Martínez', 'Calle Sur, Ciudad');
...
(2, 1, '55555555', 'Teléfono principal'),
(2, 2, '99999999', 'Teléfono secundario'),
(3, 1, '11111111', 'Teléfono principal');
--salario
